...
class ProductOptionsAiSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->displayFinalSummary($successCount, $failCount, $aiProcessedCount, $manualProcessedCount, count($products));
    }
     ...
     * Display final summary
     */
    private function displayFinalSummary($successCount, $failCount, $aiProcessedCount, $manualProcessedCount, $totalProducts)
    {
        $this->command->info("\n" . str_repeat('=', 50));
    ...
    /**
     * Run with AI disabled (manual processing only)
     */
    ...
    public function runForProduct($productId)
    {
        ...
        // You would need to have the product URL or fetch it differently
        // This is just a placeholder for the single product processing logic
        $this->command->info("Processing product: " . $product->name);
        // Add your single product processing logic here
    }
}