...
class ProductTextAdSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $promoTexts = [
            ...
            ['name' => 'شحن مجاني + خصم ١٥٪ للطلبات فوق ٥٠٠ ر.س',   'icon' => 'fa-truck-fast'],
            ...
            ['name' => 'شحن مجاني عند الطلب فوق ٣٠٠ ر.س فقط',       'icon' => 'fa-truck'],
            ...
            ['name' => 'شحن مجاني للطلبات فوق ٤٠٠ ر.س',             'icon' => 'fa-truck-fast'],
