    ...
    <div aria-label="footer"
        ...
        <div class="container xl:px-0 grid grid-cols-6 gap-10 lg:gap-6">
            <div
                ...
                <a href="{{ route('website.home') }}" class="footer-logo">
                    <img src="{{ asset('website/images/tala,.png') }}" alt="" class="img-fluid max-h-[70px]">
                </a>
                <p class="max-w-[400px] leading-6 mb-4">
                    TALA مؤسسة سعودية معرّفه في وزارة التجارة "معروف" متخصصين في تصنيع المطبوعات وتقديم
                    خدمات التصميم الفريدة والمتميزة
                </p>
                <ul class="s-social-list">
                    <li class="s-social-link"><a href="https://www.instagram.com/.co/" rel="noopener" target="_blank"
                            title="instagram" aria-label="instagram"><span
            ...
            <div class="col-span-3 lg:col-span-2">
                ...
                <div>
                    <div class="s-menu-footer-list"><a href="{{ route('website.privacy') }}" target="_self"
                            ...
                            href="{{ route('website.product.unreachable') }}" target="_self"
                            class="s-menu-footer-item">لا تستطيع الوصول للمنتج؟ ( قاموس البحث هنا
                            )</a><a href="{{ route('website.faq') }}" target="_self" class="s-menu-footer-item">الأسئلة
                            الشائعة</a><a href="{{ route('website.complain') }}" target="_self"
                            class="s-menu-footer-item">للشكاوي والاقتراحات</a><a href="{{ route('website.replace') }}"
                            target="_self" class="s-menu-footer-item">سياسة الاستبدال والاسترجاع</a><a
                            href="{{ route('website.static_print') }}" target="_self" class="s-menu-footer-item">سياسة
                            الطباعة والتصميم</a><a href="{{ route('website.gifts') }}" target="_self"
                            class="s-menu-footer-item">نظام
                            المكافآت</a></div>
                </div>
            </div>
            ...
            <div class="col-span-3 lg:col-span-1">
                ...
                <div class="s-contacts-list s-contacts-list-vertical">
                    <div id="contact-slot">
                        <a href="https://wa.me/966501556342" target="_blank" class="s-contacts-item">
                            ...
                            <span class="unicode">+966501556342</span>
                        </a>

                    </div>
                    <div id="contact-slot"><a href="mailto:support@tala.co" class="s-contacts-item"><span
                            ...
                            </span><span class="unicode">support@tala.co</span></a></div>
                </div>
            </div>
        </div>
        ...
        <div
            ...
            <div class="text-sm">
                <p class="text-gray-400 mb-2.5 md:mb-0">الحقوق محفوظة | 2025
                    <a href="#" class="hover:text-primary" target="_blank" rel="noreferrer"
                        class="underline">Tala</a>
                </p>
            </div>

            <div class="flex flex-col-reverse lg:flex-row">
                <div class="flex items-center justify-center gap-2 rtl:lg:ml-2 ltr:lg:mr-2 mb-3 lg:mb-0">
                    <p class="text-sm">الرقم الضريبي : 00003</p>
                </div>
