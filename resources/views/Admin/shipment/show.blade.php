                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <!-- Admin Information -->
                            <div class="col-md-6">
                                <h6 class="mb-3">معلومات المسؤول</h6>
                                <table class="table table-bordered">
                                    <tr>
                                        <th>الاسم</th>
                                        <td>{{ $shipment->admin_create->name ?? '--' }}</td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <th>الخصم</th>
                                        <td>{{ $shipment->discount ?? '0' }}{{ $shipment->is_rate ? '%' : '' }}</td>
                                    </tr>
                                    <tr>
                                        <th>المتبقى</th>
                                        <td>
                                    ...
                                    <tr>
                                        <th colspan="2" class="text-center">الملغ</th>
                                    </tr>
                                    <tr>
                                        <th>عمولة التجميع</th>
                            ...
                            <!-- Expenses -->
                            <div class="col-md-12">
                                <h6 class="mb-3">المصاريف</h6>
                                @if ($shipment->expenses->isNotEmpty())
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                        ...
                                        <tbody>
                                            @foreach ($shipment->expenses as $index => $expense)
                                                <tr>
                                                    <td>{{ $index + 1 }}</td>
                                                    <td>{{ $expense->price ?? '--' }}
                                                        {{ $shipment->effective_currency_label ?? '' }}</td>
                                                    <td>{{ $expense->reason ?? '--' }}</td>
                                                    <td>{{ $expense->created_at->toDateTimeString() }}</td>
                                                    <td>{{ $expense->updated_at->toDateTimeString() }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                @else
                                    <p>لا توجد مصاريف مرتبطة بالشحنة</p>
                                @endif
                            </div>
                        </div>
                        <!-- Action Buttons -->
