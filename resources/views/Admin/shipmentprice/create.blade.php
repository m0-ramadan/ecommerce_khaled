...
<div class="card">
  ...
  <form class="form theme-form" action="{{route('admin.shipmentprice.store')}}" method="post" enctype="multipart/form-data">
    @csrf
  ...
  <label class="mr-sm-2" for="validationCustom02" style="font-family: 'Cairo', sans-serif;">company</label>
