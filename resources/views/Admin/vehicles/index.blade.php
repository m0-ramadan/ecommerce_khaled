...
<div class="col-sm-12">
    <div class="card">
        <div class="card-header">
            ...
            <a class="btn btn-success" href="{{route('admin.vehicles.create')}}">اضافة جديد</a>
        </div>
        <div class="card-body">
                        ...
                        <tr>
                           ...
                           <td class="text-center">{{$list->name}}</td>
                              <td style="text-align: center;"   class="d-flex gap-1">
                               <button class="btn btn-success"> <a  href="{{route('admin.vehicles.edit',[$list->id])}}"><i class="fa fa-edit text-white"></i>  </a> </button>
                                <form method="post" action="{{route('admin.vehicles.destroy',$list->id)}}">
                                    @csrf
                                    @method('DELETE')
