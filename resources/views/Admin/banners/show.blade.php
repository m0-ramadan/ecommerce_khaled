                ...
                <div class="detail-content">
                    ...
                    <div class="info-section">
                        ...
                        <div class="info-item">
                            ...
                            <span class="info-value">
                                <span class="badge-custom {{ $banner->is_active ? 'badge-active' : 'badge-inactive' }}">
                    ...
                    <div class="info-section">
                        ...
                        <div class="info-item">
                            ...
                            <span class="info-value">
                                <span class="badge-custom {{ $banner->sliderSetting->autoplay ? 'badge-active' : 'badge-inactive' }}">
                        ...
                        <div class="info-item">
                            ...
                            <span class="info-value">{{ $banner->sliderSetting->autoplay_speed }} ملي ثانية</span>
                        </div>
                        @endif
                        ...
                        <div class="info-item">
                            ...
                            <span class="info-value">
                                <span class="badge-custom {{ $banner->sliderSetting->arrows ? 'badge-active' : 'badge-inactive' }}">
                        ...
                        <div class="info-item">
                            ...
                            <span class="info-value">
                                <span class="badge-custom {{ $banner->sliderSetting->dots ? 'badge-active' : 'badge-inactive' }}">
                        ...
                        <div class="info-item">
                            ...
                            <span class="info-value">
                                <span class="badge-custom {{ $banner->sliderSetting->infinite ? 'badge-active' : 'badge-inactive' }}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="d-flex justify-content-between align-items-start mb-2">
                                                    ...
                                                    <div>
                                                        <span class="badge-custom {{ $item->is_active ? 'badge-active' : 'badge-inactive' }}">
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    @if($item->promoCodes->count() > 0)
                                                        @foreach($item->promoCodes as $promo)
                                                            <span class="promo-badge" title="{{ $promo->description }}">
                                                                {{ $promo->code }}
                                                            </span>
                                                        @endforeach
                                                    @endif
