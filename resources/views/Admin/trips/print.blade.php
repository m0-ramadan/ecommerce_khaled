...
<body>
    ...
    <!-- Shipments of the Trip -->
    @if ($trip->shipments->isNotEmpty())
        <h2 class="section-title">شحنات الرحلة</h2>
        <table>
            <thead>
                <tr>
                    <th>#</th>
                            ...
                            @if ($shipment->contents->isNotEmpty())
                                <div class="grid grid-cols-2 gap-4">
                                    @foreach ($shipment->contents as $content)
                                        @php
                                            $tripContent = \App\Models\TripShipmentContent::where(
                                                'shipment_content_id',
                                                $content->id,
                                            )
