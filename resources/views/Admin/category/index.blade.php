                ...
                <div class="row" bis_skin_checked="1">
                    ...
                    <div class="col-md-3 mb-3" bis_skin_checked="1">
                        ...
                        <select name="parent_id" id="parent_id" class="form-select">
                            ...
                            <option value="null" {{ request('parent_id') === 'null' ? 'selected' : '' }}>الأقسام الرئيسية فقط</option>
                    ...
                    <div class="col-md-2 mb-3" bis_skin_checked="1">
                        ...
                        <div class="d-grid gap-2 d-md-block" bis_skin_checked="1">
                            ...
                            <a href="{{ route('admin.categories.index') }}" class="btn btn-outline-secondary waves-effect">
        ...
        <div class="p-3 d-flex justify-content-between align-items-center" bis_skin_checked="1">
            ...
            <div bis_skin_checked="1">
                <div class="btn-group" role="group" aria-label="Category Actions" bis_skin_checked="1">
                    <button type="button" class="btn btn-primary waves-effect" data-bs-toggle="modal" data-bs-target="#addCategoryModal">
                        <i class="fas fa-plus-circle"></i> إضافة قسم
                    </button>
                    
                    <!-- Add Subcategory Button -->
                    <button type="button" class="btn btn-success waves-effect" data-bs-toggle="modal" data-bs-target="#addSubcategoryModal">
                            ...
                            <td>
                                ...
                                @if(!is_null($category->parent_id))
                                    ...
                                    <small class="text-muted">
                                        <i class="fas fa-level-up-alt fa-rotate-90"></i> تابع لـ: {{ $category->parent->name ?? 'غير محدد' }}
                                    </small>
                                @endif
                                @if($category->slug)
                                    <br>
                            ...
                            <td>
                                <div class="dropdown" bis_skin_checked="1">
                                    ...
                                    <div class="dropdown-menu action-dropdown" bis_skin_checked="1">
                                        ...
                                        @if(is_null($category->parent_id))
                                            <a class="dropdown-item" href="{{ route('admin.categories.index', ['parent_id' => $category->id]) }}">
...
<div class="m-3">
    <nav>
        <ul class="pagination">
            ...
            @else
                <li class="page-item">
                    <a class="page-link waves-effect" href="{{ $categories->previousPageUrl() }}" rel="prev">‹</a>
                </li>
            @endif
            ...
            @if ($categories->hasMorePages())
                <li class="page-item">
                    <a class="page-link waves-effect" href="{{ $categories->nextPageUrl() }}" rel="next">›</a>
                </li>
            @else
                <li class="page-item disabled" aria-disabled="true">
                    <span class="page-link waves-effect" aria-hidden="true">›</span>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="file" class="form-control" id="sub_image" name="sub_image" accept="image/*">
                        </div>
                    </div>
                </div>
        ...
        <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="sub_name" class="form-label">اسم القسم الفرعي <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="sub_name" name="name" required>
                        </div>
                        
                        <div class="col-md-6 mb-3">
                            <label for="sub_parent_id" class="form-label">القسم الرئيسي <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" id="sub_order" name="order" value="0" min="0">
                        </div>
                        
                        <div class="col-md-6 mb-3">
                            <label for="sub_status_id" class="form-label">الحالة <span class="text-danger">*</span></label>
...
<script>
    $(document).ready(function() {
        ...
        function loadCategoryTree() {
            $.ajax({
                url: '{{ route("admin.categories.getTree") }}',
                type: 'GET',
                success: function(response) {
                    if (response.success) {
                ...
                error: function() {
                    $('#category-tree').html(
                        '<div class="alert alert-danger">فشل في تحميل بيانات الأقسام</div>'
                    );
                }
            });
        }
