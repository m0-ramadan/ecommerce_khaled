...
<div class="col-sm-12">
    <div class="card">
        <div class="card-header">
            ...
            <a class="btn btn-success" href="{{route('admin.notes.create')}}">اضافة جديد</a>
        </div>
        <div class="card-body">
                        ...
                        <tr>
                           ...
                           <td class="text-center">{{$list->text}}</td>
                              <td style="text-align: center;"   class="d-flex gap-1">
                               <button class="btn btn-success"> <a  href="{{route('admin.notes.edit',[$list->id])}}"><i class="fa fa-edit text-white"></i>  </a> </button>
                                <form method="post" action="{{route('admin.notes.destroy',$list->id)}}">
                                    @csrf
                                    @method('DELETE')
