      ...
      <div class="row g-3  mb-3">
                  ...
                  <div class="row g-3  mb-3">
                    <div class="col-md-8 m-2">
                      ...
                      <input class="form-control @error('image') is-invalid fparsley-error parsley-error @enderror" name="unit" id="exampleInputPassword2" type="text" placeholder="unit" value="{{old('unit')}}">
                      @error('unit')
                      <span class="invalid-feedback text-black font-weight-bold text-capitalize mt-2" role="alert">
                        <p>{{ $message }}</p>
                      </span>
