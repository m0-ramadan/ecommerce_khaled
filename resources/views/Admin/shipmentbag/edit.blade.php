...
<div class="card">
  ...
  <div class="row g-3  mb-3">
                  ...
                  <div class="row g-3  mb-3">
                    <div class="col-md-8 m-2">
                      <label class="mr-sm-2" for="validationCustom02" style="font-family: 'Cairo', sans-serif;">unit</label>
                      <input class="form-control @error('image') is-invalid fparsley-error parsley-error @enderror" name="unit" id="exampleInputPassword2" type="text" placeholder="unit" value="{{old('unit' ,$package->unit ?? '')}}">
                      @error('unit')
                      <span class="invalid-feedback text-black font-weight-bold text-capitalize mt-2" role="alert">
                        <p>{{ $message }}</p>
                      </span>
