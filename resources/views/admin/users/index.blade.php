                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div>
                                @can('edit users')
                                <button class="btn-success btn-lg" style="font-family: 'Cairo', sans-serif;" data-bs-toggle="modal" data-bs-target="#addUserModal" title="إضافة مستخدم">
                                    أضـــــافة
                                </button>
                                @endcan
                            </div>
                                        ...
                                        @foreach ($users as $index => $user)
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-sm btn-danger" type="button"
                                                      ...
                                                      <button class="btn btn-success" type="button" data-bs-toggle="modal" data-bs-target="#editRoleModal{{ $user->id }}" title="تعديل دور المستخدم">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="editRoleModalLabel">تعديل دور الموظف</h5>
                                                      ...
                                                      <form action="{{ route('users.update', $user->id) }}" method="POST">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="role" id="role" class="form-control" required>
                                                                        ...
                                                                        <option value="super-admin" {{ $user->type == 'super-admin' ? 'selected' : '' }}>مدير أعلى</option>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button class="btn btn-success" type="submit">تعديل الدور</button>
                                                            </div>
                                                        </form>
                                            ...
                                            <div class="modal fade" id="deleteUserModal{{ $user->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteUserModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="deleteUserModalLabel">حذف الموظف</h5>
                                                            <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
            ...
            <form action="{{ route('users.store') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="form-control" required placeholder="أدخل اسم المستخدم">
                    </div>
                    <div class="form-group">
                        <label for="email">البريد الالكتروني</label>
                        <input type="email" name="email" id="email" class="form-control" required placeholder="أدخل البريد الالكتروني">
                    </div>
                    <div class="form-group">
                        <label for="password">كلمة المرور</label>
