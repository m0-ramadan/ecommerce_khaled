    ...
    <div class="page-body">
        ...
        <div class="container-fluid">
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-6">
                        <h3 style="font-family: 'Cairo', sans-serif;">ارشيف الألهام والأفكار</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('admin/dashboard')}}" style="font-family: 'Cairo', sans-serif;">الرئيسيــــــة</a></li>
                            <li class="breadcrumb-item" style="font-family: 'Cairo', sans-serif;">ارشيف الألهام والأفكار</li>
                        </ol>
                    </div>
                    <div class="col-sm-6">
                    </div>
                                    ...
                                    @foreach($inspirations as $inspiration)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-danger" type="button" data-bs-toggle="modal"
                                                        data-original-title="test" data-bs-target="#exampleModal{{$inspiration->id}}"><i class="fa fa-undo"></i>
                                                </button>
                                            </td>
                                        </tr>
                                        ...
                                        <div class="modal fade" id="exampleModal{{$inspiration->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">استرجاع</h5>
                                                        <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                  <form action="{{route('inspiration.destroy',$inspiration->id)}}" method="post">
                                                        ...
                                                        <input id="id" type="hidden" name="id" class="form-control"
                                                               value="{{ $inspiration->id }}">
                                                                ...
                                                                <input id="id" type="hidden" name="idinspiration" class="form-control"
                                                               value="1">
                                                        <div class="modal-body">هل أنت متاكد من عملية استعادة مرة اخرى  </div>
                                                        <div class="modal-footer">
                                                            <button class="btn btn-primary" type="button" data-bs-dismiss="modal">غلق</button>
                                                            <button class="btn btn-secondary" type="submit">استعادة</button>
                                                        </div>
                                                    </form>
