                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">ارشيف المتاجر</li>
                        </ol>
                    </div>
                    <div class="col-sm-6">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-primary" type="button" data-bs-toggle="modal"
                                                            data-original-title="test" data-bs-target="#exampleModal{{$store->id}}"><i class="fa fa-window-restore"></i>
                                                 </button>
                                            </td>
                                        </tr>
                                        ...
                                        <div class="modal fade" id="exampleModal{{$store->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{route('storeRestore',$store->id)}}" method="post">
                                                        @csrf
                                                        <input id="id" type="hidden" name="id" class="form-control"
                                                               value="{{ $store->id }}">
                                                        <div class="modal-body">هل أنت متاكد من استرجاع هذا المتجر</div>
