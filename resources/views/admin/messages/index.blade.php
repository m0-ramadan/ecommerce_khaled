        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <button class="btn-danger btn-lg mb-2" style="font-family: 'Cairo', sans-serif;" data-bs-toggle="modal" data-bs-target="#deleteAllMessagesModal" title="حذف كل الرسائل">
                                حذف كل الرسائل
                            </button>
                            <br>
                                ...
                                <table class="display datatables" id="dt-plugin-method">
                                    ...
                                    @foreach($supports as $support)
                                        <tr style="text-align: center">
                                            ...
                                            <td>{{$support->phone}}</td>
                                                @if($support->status)
                                                    <td style="font-family: 'Cairo', sans-serif;"><span style="color: #3B8403; padding: 6px; " >{{$support->message}}</span></td>
                                                    @else
                                                    <td style="font-family: 'Cairo', sans-serif;"><span style="color: #ED6B27; padding: 6px; ">{{$support->message}}</span></td>
                                                @endif
                                            <td>{{$support->notes}}</td>
                                            <td>
...
<div class="modal fade" id="deleteAllMessagesModal" tabindex="-1" aria-labelledby="deleteAllMessagesModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteAllMessagesModalLabel">تأكيد الحذف</h5>
            ...
            <div class="modal-footer">
                ...
                <form action="{{ route('messages.deletell') }}" method="POST" style="display: inline;">
                    @csrf
