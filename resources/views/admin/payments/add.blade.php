                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{url('admin/payments')}}">طـــرق الدفـــع</a></li>
                            <li class="breadcrumb-item" style="font-family: 'Cairo', sans-serif;">أضافــة طــريقــة دفــع</li>
                        </ol>
                    </div>
                    <div class="col-sm-6">
                    </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header pb-0">
                            <h5 style="font-family: 'Cairo', sans-serif;">أضافــة طــريقــة دفــع</h5>
                        </div>
                        <div class="card-body">
                            <form class="needs-validation" novalidate="" enctype="multipart/form-data" method="post" action="{{route('payments.store')}}">
                                @csrf
                                <br>
