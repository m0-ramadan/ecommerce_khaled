    ...
    <div class="page-body">
        ...
        <div class="container-fluid">
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-6">
                        <h3 style="font-family: 'Cairo', sans-serif;">شركاء النجاح</h3>
                        <ol class="breadcrumb">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <div>
                                <a href="{{url(route('groups.create'))}}"><button class="btn-success btn-lg" style="font-family: 'Cairo', sans-serif;">أضافـــــــة</button></a>
                            </div>
                            <br>
                            <div class="table-responsive">
                                <table class="display datatables" id="dt-plugin-method">
                                    ...
                                    <tr>
                                        <th>#</th>
                                        <th style="font-family: 'Cairo', sans-serif;text-align:center">الصــــــورة</th>
                                        <th style="font-family: 'Cairo', sans-serif;text-align:center">الـــرابــط</th>
                                        <th style="font-family: 'Cairo', sans-serif;text-align:center">العمليـــات</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?php $i = 0; ?>
                                    @foreach($payments as $payment)
                                        <tr>
                                            ...
                                            <td  style="text-align:center "><img width="50" src="{{asset('public/' . $payment->image)}}"></td>
                                            <td  style="text-align:center ">{{$payment->link}}</td>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{route('groups.update',$payment->id)}}" method="post" enctype="multipart/form-data">
                                                            {{ method_field('patch') }}
                                                            @csrf
                                                            <div>
                                                                <div>
                                        ...
                                        <div class="modal fade" id="exampleModal{{$payment->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{route('groups.destroy',$payment->id)}}" method="post">
                                                        {{ method_field('Delete') }}
                                                        @csrf
